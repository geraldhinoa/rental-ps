        ...
        <div class="bg-slate-900/40 backdrop-blur-xl border border-white/10 rounded-[2rem] p-8 shadow-2xl relative overflow-hidden">
            ...
            <form method="POST" action="/admin/login" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="adminrentalps@gmail.com" required class="w-full bg-slate-950 border border-white/10 rounded-xl px-4 py-3.5 text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all font-medium text-sm">
                </div>
                <div>
