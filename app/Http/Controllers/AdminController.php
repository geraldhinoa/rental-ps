...
class AdminController extends Controller
{
    public function index()
    {
        ...
        return view('admin.dashboard', compact('revenue', 'activeRentals', 'pendingBookings', 'bookings', 'activePS5', 'activePS4', 'activePS3', 'totalMachines', 'availableMachines', 'chartLabels', 'chartData'));
    }
    ...
    public function inventory()
    {
        ...
        return view('admin.inventory', compact('ps5Count', 'ps4Count', 'ps3Count', 'inventories', 'categories'));
    }
    ...
    public function bookings()
    {
        ...
        return view('admin.bookings', compact('bookings', 'inventories'));
    }
